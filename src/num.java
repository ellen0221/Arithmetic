public class num {
    ...
    public num add(num n) { // 加法 a + b
        return easy(new num((this.b*n.a + this.a*n.b), this.b*n.b));
    }

    public num sub(num n) { // 减法 a - b
        return easy(new num((this.a*n.b - this.b*n.a), this.b*n.b));
    }

    public num mul(num n) { // 乘法 a * b
        return easy(new num(this.a*n.a, this.b*n.b));
    }

    public num div(num n) { // 除法 a / b
        return easy(new num(this.a*n.b, this.b*n.a));
    }
